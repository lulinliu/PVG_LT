...
RECON_MODEL_ROOT="$CODE_ROOT/eval_output/waymo_reconstruction_longtail_tuned_first49"
NVS_MODEL_ROOT="$CODE_ROOT/eval_output/waymo_nvs_longtail_tuned_first49"
EVAL_OUTPUT_ROOT="$CODE_ROOT/eval_output/longtail_tuned_region_metrics_first49"
