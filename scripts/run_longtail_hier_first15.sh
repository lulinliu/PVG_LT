...
RECON_CONFIG="configs/waymo_reconstruction_longtail_hier_first15.yaml"
RECON_MODEL_ROOT="$CODE_ROOT/eval_output/waymo_reconstruction_longtail_hier_first15"
EVAL_OUTPUT_ROOT="$CODE_ROOT/eval_output/longtail_hier_first15_metrics"
