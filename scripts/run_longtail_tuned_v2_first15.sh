...
RECON_MODEL_ROOT="$ROOT/eval_output/waymo_reconstruction_longtail_tuned_v2_first15"
NVS_MODEL_ROOT="$ROOT/eval_output/waymo_nvs_longtail_tuned_v2_first15"
EVAL_OUTPUT_ROOT="$ROOT/eval_output/longtail_tuned_v2_first15_metrics"
